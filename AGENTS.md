...
The tracked equivalent of the Claude session-start hook is defined in
`.codex/hooks.json`.

## Maintaining this file

Update this file when verified repository behavior changes. Keep `CLAUDE.md` as
the compatibility import unless Claude-specific guidance is genuinely required.
